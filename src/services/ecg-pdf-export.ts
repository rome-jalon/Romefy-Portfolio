...
export async function exportEcgReportToPDF(element: HTMLElement): Promise<void> {
  ...
  pdf.text('ECG Analysis Report', margin, margin + 6)
  ...
  pdf.save(`ecg-analysis-report-${Date.now()}.pdf`)
}
